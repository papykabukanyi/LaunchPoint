<template>
        ...
        >
          <div class="pricing-card" :class="{ featured: svc.featured }">
            ...
            <div class="pricing-price mb-3">
              <span class="price-from" v-if="svc.priceLabel !== 'Custom'">starting at</span>
              <span class="price-amount">{{ svc.priceLabel }}</span>
              <span class="price-period" v-if="svc.period">&nbsp;{{ svc.period }}</span>
            </div>
  ...
  <section id="service-contact" style="padding:80px 0;background:#f8f9fb;">
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4" data-aos="fade-right">
          <div class="contact-info-panel">
            ...
            <p class="small text-muted">All pricing shown is a starting point. After reviewing your inquiry we'll send a detailed custom proposal tailored to your exact goals and budget.</p>
