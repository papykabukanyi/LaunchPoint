...
A modern, professional political marketing website built with HTML5, CSS3, and JavaScript. This responsive website includes a hero section, about section, policy platform, and a functional contact form with validation.
